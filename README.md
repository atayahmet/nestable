Laravel 5 Nestable From atayahmet/laravel-nestable
========

What Is different here?
---
Just Changed the default config to add the name of the keys
This will give you the flexibility to work with any Js libraries.
